          ...
          "breadcrumb": {
            ...
            "itemListElement": [
              ...
              },
              {
                ...
                "position": 3,
                "name": product.name,
                "item": `${siteConfig.site_domain}/products/sf6-regeneration-system`
              }
            ]
          }
        })}
            ...
            <div className="space-y-4">
              <div className="aspect-square bg-gray-100 rounded-lg overflow-hidden">
                <img 
                  ...
                  onError={(e) => {
                    (e.target as HTMLImageElement).src = "https://via.placeholder.com/600x600?text=SF6+Regeneration+System";
                  }}
                />
              </div>
              ...
              <Card>
                <CardContent className="p-6">
                  ...
                  <div className="prose max-w-none text-gray-600 space-y-4">
                    <p>
                      The {product.name} is an advanced system designed for the purification and regeneration
                      of used SF6 gas. This innovative solution restores SF6 to its original purity levels,
                      allowing for reuse and reducing environmental impact.
                    </p>
                    <p>
                      Equipped with state-of-the-art filtration and purification technology, this system
                      effectively removes moisture, impurities, and decomposition products from used SF6 gas.
                      The digital control system ensures precise operation and monitoring of the regeneration process.
                    </p>
              ...
              <Card id="inquiry" className="sticky top-24">
                <CardContent className="p-6">
                  ...
                  >
                    ...
                    <input type="hidden" name="referer" value={`${siteConfig.site_domain}/products/sf6-regeneration-system`} />
