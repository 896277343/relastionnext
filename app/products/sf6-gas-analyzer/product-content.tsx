          ...
          "breadcrumb": {
            ...
            "itemListElement": [
              ...
              },
              {
                ...
                "position": 3,
                "name": product.name,
                "item": `${siteConfig.site_domain}/products/sf6-gas-analyzer`
              }
            ]
          }
        })}
            ...
            <div className="space-y-4">
              <div className="aspect-square bg-gray-100 rounded-lg overflow-hidden">
                <img 
                  ...
                  onError={(e) => {
                    (e.target as HTMLImageElement).src = "https://via.placeholder.com/600x600?text=SF6+Gas+Analyzer";
                  }}
                />
              </div>
              ...
              <Card>
                <CardContent className="p-6">
                  ...
                  <div className="prose max-w-none text-gray-600 space-y-4">
                    <p>
                      The {product.name} is an advanced analytical instrument designed for comprehensive
                      analysis of SF6 gas quality. This portable device provides accurate measurement
                      of moisture content, purity levels, and decomposition products in SF6 gas.
                    </p>
                    <p>
                      Equipped with state-of-the-art sensing technology and a user-friendly touchscreen
                      interface, this analyzer delivers precise results in minutes. The portable design
                      makes it ideal for both laboratory and field applications, ensuring SF6 gas
                      quality compliance and equipment reliability.
                    </p>
              ...
              <Card id="inquiry" className="sticky top-24">
                <CardContent className="p-6">
                  ...
                  >
                    ...
                    <input type="hidden" name="referer" value={`${siteConfig.site_domain}/products/sf6-gas-analyzer`} />
